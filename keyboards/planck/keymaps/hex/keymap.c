 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn2  | Ctrl | Alt  | GUI  |Lower | Bksp |  Spc |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {FUNC2, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_BSPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},

 /* Fn
 * ,-----------------------------------------------------------------------------------.
 * | Esc  |      |  Up  |      |      |      | NmLk |  N7  |  N8  |  N9  |  N\  |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      | Left | Down |Right |      |      |      |  N4  |  N5  |  N6  |  N*  | Bksp |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |  N1  |  N2  |  N3  |  N-  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |  Del |  N0  |  N.  | NEnt |  N+  |      |
...
[_FUNC2] = {
  ...
  {_______, RGB_TOG,RGB_RMOD, RGB_MOD, RGB_M_P, _______, _______, _______, _______, _______, _______, _______},
