...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MA] = LAYOUT_ansi(
        ...
        KC_NO,     MO(_L2),    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,       KC_SCLN,       KC_QUOT,          KC_ENT,  KC_CALC,
        KC_NO,     KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,     KC_SLSH,       KC_RSFT,          KC_UP,   KC_WHOM,
        KC_NO,     KC_LCTL,    KC_LGUI, KC_LALT,                   KC_SPC,                    MO(_L1), KC_RALT,    KC_RCTL,       KC_LEFT,          KC_DOWN, KC_RGHT
    ),
    [_L1] = LAYOUT_ansi(
        ...
        _______,   KC_PSCR,    _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,       _______,          _______, _______,
        _______,   _______,    _______, _______,                   _______,                   _______, _______,    _______,       _______,          _______, _______
    ),
    [_L2] = LAYOUT_ansi(
                   KC_ESC,     _______, _______, _______,  _______, _______, _______, _______, _______, _______,   _______,       _______, _______, _______, _______,
        RGB_TOG,   _______,    _______, KC_UP,   _______,  _______, _______, KC_PAST, KC_P7,   KC_P8,   KC_P9,     _______,       _______, _______, KC_BSPC, _______,
        _______,   _______,    KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, KC_PPLS, KC_P4,   KC_P5,   KC_P6,     _______,       _______,          _______, _______,
        _______,   _______,    _______, _______, _______,  _______, _______, KC_PMNS, KC_P1,   KC_P2,   KC_P3,     _______,       _______,          _______, _______,
        _______,   _______,    _______, _______,                    KC_P0,                     KC_PSLS, KC_NUM,    _______,       _______,          _______, _______
    )
};
...
#define MA_LAYER_NAME     "QWERT"      // Layer _MA name
#define L1_LAYER_NAME     "FUNCT"      // Layer _L1 name
#define L2_LAYER_NAME     "ARRNM"      // Layer _L2 name
/*================================================================================================================*/
